...
import JobEdit from '@/pages/CompanyManagement/Job/create';

const localVue = createLocalVue();

describe(`TEST SCREEN JOB EDIT`, () => {
  test('TEST RENDER COMPONENT JOB EDIT', () => {
    const wrapper = shallowMount(JobEdit, {
      store,
      router,
      localVue,
    });
  ...
  test('TEST RENDER COMPONENT JOB EDIT DEFAULT DATA', () => {
    const wrapper = shallowMount(JobEdit, {
      store,
      router,
      localVue,
  ...
  test('TEST CALL FUNCTION handleEditJob WHEN CLICK ON SAVE BUTTON', async() => {
    const wrapper = shallowMount(JobEdit, {
      store,
      router,
      localVue,
  ...
  test('TEST CALL FUNCTION handleValidationFormData BEFORE CALL FUNCTION handleEditJob', async() => {
    const wrapper = shallowMount(JobEdit, {
      store,
      router,
      localVue,
