...
<template>
  <div
    ...
    :style="`height: ${height}; width: ${width};font-size: ${fontSize}`"
  >
    <img
    ...
    >
    <div>
      <span class="added-to-favorites">{{ $t('ADDED_TO_FAVORITES') }}</span>
      <!-- <span class="removed-to-favorites">{{ $t('REMOVE_FROM_FAVORITES') }}</span> -->
    </div>
  </div>
</template>
