    ...
    <div class="distribute-msg-frame">
      <div class="d-flex justify-content-between">
        <div>
          ...
          <h6 class="font-weight-bold">
            面接日日程調整/ Interview schedule adjustment
          </h6>
        </div>
      ...
      <div class="distribute-msg-frame__inputs-datas">
        ...
        <div>
          あなたが承認したエントリー者から面接日程調整の返信がありました。
          <b-link>こちら</b-link>から詳細を確認し、面接日程の再調整が必要な場合は、再度候補日を選択してください。
        </div>
      </div>
