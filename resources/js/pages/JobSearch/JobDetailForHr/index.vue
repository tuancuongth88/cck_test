<template>
  ...
  >
      ...
      <b-row class="py-2 mb-2">
        ...
        >
          <b-col class="title">
            ...
            <span class="title-text">{{ $t('JOB_INFORMATION') }}</span>
          </b-col>

          <div class="control-area">
            <b-button class="back-to-list-button" @click="handleBackList()">{{
              ...
              <b-list-group class="list-group-body">
                ...
                <b-list-group-item class="p-0">
                  <div class="d-flex">
                    ...
                    >
                      <span
                        v-for="(item, index) in language_requirement"
                        :key="index"
                        class="d-flex mr-3"
                      >{{ item['name'] }}</span>
                    </b-col>
                ...
                <b-list-group-item class="p-0">
                  <div class="d-flex">
                    <b-col
                      cols="3"
                      class="d-flex align-items-center bg-gray body-item-title"
                    >{{ $t('JOB_DETAIL.OTHER_SKILL') }}</b-col>
                ...
                <b-list-group-item class="p-0">
                  <div class="d-flex">
                    <b-col
                      cols="3"
                      class="d-flex align-items-center bg-gray body-item-title"
                    >{{ $t('JOB_DETAIL.PREFERRED_SKILL') }}</b-col>
                ...
                <b-list-group-item class="p-0">
                  <div class="d-flex">
                    <b-col
                      cols="3"
                      class="d-flex align-items-center bg-gray body-item-title"
                    >{{ $t('JOB_DETAIL.WORKING_PLACE_DETAIL') }}</b-col>
                ...
                <b-list-group-item class="p-0">
                  <div class="d-flex">
                    <b-col
                      cols="3"
                      class="d-flex align-items-center bg-gray body-item-title"
                    >{{ $t('JOB_DETAIL.TREATMENT_WELFARE') }}</b-col>

                    <b-col
                      cols="9"
                      class="d-flexflex-column my-2 body-item-text"
                    >
                      <span
    ...
    <div
      class="d-flex justify-content-center align-items-center job-detail-for-hr-form-btn"
    >
      <div style="width: 360px" @click="handleNavigateToSelectEntryHr()">
        <BtnMoveNext :min-width="'360px'" :direction="'next'" />
      </div>
    </div>
  </b-overlay>
</template>
...
export default {
  ...
  methods: {
    async handleInitComponentData() {
      this.$store.dispatch('job/setWorkID', this.$route.params.id);
      ...
      if (ID) {
        try {
          ...
          if (response['code'] === 200) {
            ...
            // this.company_name = this.handleGetCompanyName(DATA['company_id']);
            ...
            this.language_requirement = DATA['language_requirements'];
    ...
    async handleNavigateToSelectEntryHr() {
      await this.$store.dispatch('job/setListSelectedHr', []);
      await this.$store.dispatch('job/setListHrInformation', []);
