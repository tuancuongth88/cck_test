...
class NotificationController extends Controller
{
     ...
     *   ),
     *   @OA\Parameter(name="text", in="query", required=true,
     *     @OA\Schema(type="string"),
     *   ),
     *   @OA\Parameter(name="image_id", in="query", required=false,
     *     @OA\Schema(type="int"),
     *   ),
     *   @OA\Response(
     *     response=200,
    ...
    public function store(NotificationRequest $request)
    {
        try {
            ...
            return $this->responseJson(200, new NotificationResource($data));
        } catch (\Exception $e) {
