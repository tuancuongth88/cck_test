...
class CaseH_2 extends DuskTestCase
{
    /**
     * A Dusk test example.
     *
    ...
    public function caseRejectEntry(Browser $browser)
    {
        ...
        foreach ($types as $type) {
            ...
            $browser->pause(2000)
                ...
                ->pause(5000)
                ->type('@textarea', 'abc123')->pause(5000)
                ->click('@btn_handle_reject_entry')->pause(5000);
            ...
            $browser->click('#nav-collapse > ul > li:nth-child(1) > a')->pause(5000)
                ...
                ->pause(5000)
                ->assertSee('エントリー承認可否が設定されました')
                ->assertSee('却下')->pause(5000);

            $browser->pause(5000)->scrollIntoView('.btn-logout')
                ->click('.btn-logout');
            ...
            foreach ($typeHr as $hr) {
                ...
                $browser->click('#nav-collapse > ul > li:nth-child(4) > a')->pause(5000)
                    ...
                    ->assertSeeIn('#entry-table-list > tbody > tr:nth-child(' . $i . ') > td:nth-child(8) > span', '却下')
                    ->pause(5000)
