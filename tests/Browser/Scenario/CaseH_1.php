...
class CaseH_1 extends DuskTestCase
{
    /**
     * A Dusk test example.
     *
    ...
    public function caseConfirmEntry(Browser $browser)
    {
        ...
        foreach ($types as $type) {
            ...
            $browser->pause(5000)
                ...
                ->click('#entry-table-list > tbody > tr:nth-child(1) td > .btn-go-detail > i')
                ->pause(5000)
                ->click('@btn_requesting_confirm')
                ->click('@btn_confirm')->pause(5000);
            ...
            $browser->click('#nav-collapse > ul > li:nth-child(4) > a')->pause(5000)
                ...
                ->click('.collapse-bar-btn')->pause(5000)
                ->assertSeeIn('#interview-table > tbody > tr:nth-child(1) > td:nth-child(3)', 'E' . $entry_code)
                ...
                ->pause(5000)->scrollIntoView('.btn-logout')
                ->click('.btn-logout');
    ...
    private function selectCalendar(Browser $browser)
    {
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            $browser->scrollIntoView('#before_adjustment_modal .btn-warning')
                ->click('#table-calendar-temp tbody tr:nth-child(' . $i . ') td:nth-child(2)')->pause(5000);
            if ($title)
        ...
        $browser->click('#before_adjustment_modal .btn-warning')->pause(5000)
    ...
    public function caseSetCandidateInterview(Browser $browser)
    {
        ...
        foreach ($types as $type) {
            ...
            $browser->click('#nav-collapse > ul > li:nth-child(1) > a')->pause(5000)
                ->assertSee('面接候補日が設定されました')->pause(5000)
                ->click('#new-msg > tbody > tr > td.title > div > a')
                ->pause(5000)
                ->assertSee('面接候補日が設定されました')->pause(5000)
                ->scrollIntoView('.btn-logout')
